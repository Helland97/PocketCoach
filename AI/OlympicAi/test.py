if __name__ == "__main__":
    ...
    try:
        ...
        input_video = "videos/new_back_squat.mp4"      # Replace with your actual test video path
        output_video = "squat_back_new.mp4"    # This will be created with skeleton overlay
