if __name__ == "__main__":
    ...
    try:
        ...
        input_video = "videos/front_narrow_angle.mp4"      # Replace with your actual test video path
        output_video = "front_narrow.mp4"    # This will be created with skeleton overlay
